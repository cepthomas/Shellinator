...
// TODO1 still gotta figure out the cmd <> without terminal.
...
namespace Splunk
{
    ...
    {
        /// <summary>My logger.TODO2 needed?</summary>
        ...
        static int Run(string[] args)
        {
            ...
            try
            {
                ...
                switch (cmd)
                {
                    ...
                    case "newtab":
                        // TODO1 Open a new explorer tab in current window at the dir selected in the first one.
